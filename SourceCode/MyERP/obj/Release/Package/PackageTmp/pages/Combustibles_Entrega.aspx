<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Combustibles_Entrega.aspx.cs" Inherits="Plataforma.pages.Combustibles_Entrega" %>
...
<body>
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    ...
                    <h1 class="h3 display">Entregas de combustible</h1>
   ...
   <div id="panelEntregar" class="modal fade" role="dialog" data-backdrop="static">
    ...
    <script src="../js/cp/combustibles/combustibles_entrega.js"></script>
