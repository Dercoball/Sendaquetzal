<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoColaboracion.aspx.cs" Inherits="Plataforma.pages.MantenimientoColaboracion" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Colaboraciones</h1>
                    ...
                    <div class="table-responsive">
                        ...
                        <table style="width: 100%!important;" class="table table-striped table-bordered table-hover " id="table">
                            ...
                            <thead>
                                ...
                                <th>Fecha</th>
                                <th>
                                    <button class="btn btn-outline btn-primary" id="btnNuevo">
                                        <i class="glyphicon glyphicon-plus"></i>&nbsp;Nueva colaboración</button>
                ...
                <div id="panelForm">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <button id="btnAbrirSeleccionarRequisicion"
                                            class="btn btn-outline btn-success form-control deshabilitable">
                                            Seleccione Orden de trabajo...</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control deshabilitable" id="txtDescripcion" disabled
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control deshabilitable" id="comboPrioridad" disabled
                                            required data-required-error='Requerido'>
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class=" col-md-6 text-right">
                            <button id="btnDescargar" class="btn btn-secondary deshabilitable"><i class="fa fa-file-pdf-o"></i>&nbsp;Descargar</button>
                            <button id="btnGuardarAsociacion" class="btn btn-primary deshabilitable"><i class="fa fa-save"></i>&nbsp;Guardar asociación de colaboración</button>
                        </div>
    ...
    <script src="../js/cp/mantenimiento/colaboracion.js"></script>
