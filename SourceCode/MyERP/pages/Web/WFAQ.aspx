<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFAQ.aspx.cs" Inherits="Plataforma.pages.WFAQ" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Configuración de preguntas frecuentes</h1>
                </header>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control alto-textarea" id="txtPregunta" required="required" data-required-error='Requerido'></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="txtRespuesta">
                                            Respuesta
                                        </label>
                                        <textarea class="form-control alto-textarea" id="txtRespuesta" required="required" data-required-error='Requerido'></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-control-sm ml-2">
                                        <input id="chkActivo" checked="checked" class="form-control-sm" type="checkbox" />
    ...
    <script src="../../js/app/web/wfaq.js"></script>
