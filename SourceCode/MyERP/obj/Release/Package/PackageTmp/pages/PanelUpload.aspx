<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanelUpload.aspx.cs" Inherits="Plataforma.pages.PanelUpload" %>
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    ...
                    <h1 class="h3 display">Upload CSV con listado de empleados</h1>
                ...
                <div id="panelForm">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="txtFileCSV">
                                            Seleccione el Archivo CSV
                                        </label>
                                        <input type="file" class="form-control" id="txtFileCSV" />
                    ...
                    <div class="mt-2">
                        <h1 class="h3 display">Resumen de la subida de registros.</h1>

                        <div class="table-responsive">
                            <table style="width: 100%!important; font-size: smaller;" class="table table-sm table-striped table-bordered table-hover"
                                id="tableResultados">
                                <thead>
                                </thead>
...
<%--                    <div class="row mt-3 mb-3">
    ...
    <script src="../js/cp/nomina/panel_upload.js"></script>
