...
var table;
var date = new Date();
var descargas = "Ubicaciones_" + date.getFullYear() + "_" + date.getMonth() + "_" + date.getUTCDay() + "_" + date.getMilliseconds();
var pagina = '48';
...
$(document).ready(function () {
    ...
    function cargarItems() {
        ...
        $.ajax({
            type: "POST",
            url: "../pages/Ubicaciones.aspx/GetListaItems",
            data: parametros,
    ...
    $('#btnGuardar').click(function (e) {
        ...
        if (!hasErrors) {
            ...
            var item = new Object();
            item.IdUbicacion = idSeleccionado;
            ...
            $.ajax({
                type: "POST",
                url: "../pages/Ubicaciones.aspx/Guardar",
                data: parametros,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: true,
    ...
    $('#btnEliminarAceptar').on('click', function () {
        ...
        $.ajax({
            type: "POST",
            url: "../pages/Ubicaciones.aspx/EliminarItem",
            data: parametros,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
...
function editar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../pages/Ubicaciones.aspx/GetItem",
        data: parametros,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: true,
        success: function (msg) {
            ...
            idSeleccionado = datosItem.IdUbicacion;
            accion = "editar";
