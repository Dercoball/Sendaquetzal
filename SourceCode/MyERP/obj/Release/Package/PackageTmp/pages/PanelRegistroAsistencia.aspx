<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanelRegistroAsistencia.aspx.cs" Inherits="Plataforma.pages.PanelRegistroAsistencia" %>
...
<body>
        ...
        <section class="forms">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-empleados-tab" data-toggle="tab"
                        href="#nav-empleados" role="tab" aria-controls="nav-empleados" aria-selected="false">Asistencia</a>
                </div>
            </nav>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-obras" role="tabpanel" aria-labelledby="nav-obras-tab">
                    ...
                    <div class="container-fluid">
                        <header>
                            <h1 class="h3 display">Pre-Nómina</h1>
                        </header>
                ...
                <div class="tab-pane fade" id="nav-empleados" role="tabpanel" aria-labelledby="nav-empleados-tab">
                    <div class="container-fluid">
                        ...
                        <header>
                            <h1 class="h3 display">Asistencia</h1>
                        </header>
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class=" col-md-6 text-right">
                            ...
                            <button id="btnEnviar" class="btn btn-primary"><i class="fa fa-send"></i> Enviar</button>
                        </div>
     ...
     <div id="panelEnviar" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Se enviara a la siguiente etapa la prenomina actual. ¿Desea continuar?
                    </p>
                </div>
                <div class="modal-footer">
                    <button id="btnAceptarEnviar" class="btn btn-danger" data-dismiss="modal">Aceptar</button>
    ...
    <script src="../js/cp/nomina/panel_registro_asistencia.js"></script>
