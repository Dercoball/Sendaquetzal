<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="Plataforma.pages.Marcas" %>
...
<body>
                        ...
                        <form role="form" id="frm" name="frm" data-toggle="validator">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtNombre" placeholder="Marca"
    ...
    <script src="../js/cp/catalogos/marcas.js"></script>
