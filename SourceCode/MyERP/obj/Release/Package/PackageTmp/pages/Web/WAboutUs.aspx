<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WAboutUs.aspx.cs" Inherits="Plataforma.pages.WAboutUs" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Configuración de acerca de nosotros</h1>
                </header>
    ...
    <script src="../../js/app/web/waboutus.js"></script>
