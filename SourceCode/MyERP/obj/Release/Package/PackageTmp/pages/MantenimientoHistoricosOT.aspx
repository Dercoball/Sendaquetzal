<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoHistoricosOT.aspx.cs" Inherits="Plataforma.pages.MantenimientoHistoricosOT" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Listado histórico de órdenes de trabajo.</h1>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control deshabilitable" id="txtDescripcion"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="form-group" id="divEmpleados">
                                            <label>Empleado para diagnóstico (Cambiar/Reasignar) </label>
    ...
    <script src="../js/cp/mantenimiento/listado_fallas_historico.js"></script>
