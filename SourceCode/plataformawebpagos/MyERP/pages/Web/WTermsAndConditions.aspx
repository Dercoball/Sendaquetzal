<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WTermsAndConditions.aspx.cs" Inherits="Plataforma.pages.WTermsAndConditions" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Configuración de términos y condiciones</h1>
                </header>
    ...
    <script src="../../js/app/web/wtermsandconditions.js"></script>
