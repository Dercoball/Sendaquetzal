<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Puestos.aspx.cs" Inherits="Plataforma.pages.Puestos" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Puestos</h1>
    ...
    <script src="../js/cp/catalogos/catalogo_puestos.js"></script>
