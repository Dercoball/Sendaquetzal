<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Combustibles_Aprobacion.aspx.cs" Inherits="Plataforma.pages.Combustibles_Aprobacion" %>
...
<body>
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    ...
                    <h1 class="h3 display">Aprobación de solicitudes de combustible</h1>
                        ...
                        <div id="panelForm">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <button id="btnCancelar" class="btn btn-secondary"><i class="fa fa-arrow-circle-left mr-1"></i>Regresar</button>

                                </div>
                                <div class="col-md-6 text-right">
                                    <%--                                    <button id="btnAprobar" class="btn btn-primary"><i class="fa fa-save mr-1"></i>Aprobar</button>                                    --%>
                                </div>
                            </div>
                        </div>
    ...
    <div id="panelAprobarGeneral" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="btnAprobarAceptar" class="btn btn-primary btnAprobarAceptar" data-dismiss="modal">Aceptar</button>
    ...
    <div id="panelAprobarIndividuales" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label id="msgAprobarIndividual">
                        </label>
                    </div>

                    <div class="form-group">
                        <label for="comboProveedorCombustible">Proveedor combustible:</label>
                        <select class="form-control" id="comboProveedorCombustible"
                ...
                <div class="modal-footer">
                    <button id="btnAprobarIndividualAceptar" class="btn btn-primary btnAprobarAceptar">Aceptar</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancelar</button>
                </div>
            </div>
        </div>
    ...
    <div id="panelEliminar" class="modal fade" role="dialog" data-backdrop="static">
     ...
     <div id="panelImagenes" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Imágenes</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <label>
                                Fotografía tablero antes de carga
                            </label>

                            <div class="card bg-light" style="width: 18rem;">
                                <div class="card-body text-center">
                                    <img src="../img/logo_small.jpg" id="img_1" class="img-fluid" />

                                </div>
                            </div>

                            <input type="file" class="form-control file-fotografia1" />
                            <div class="help-block with-errors"></div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <label>
                                Foto tablero después de carga
                            </label>

                            <div class="card bg-light" style="width: 18rem;">
                                <div class="card-body text-center">
                                    <img src="../img/logo_small.jpg" id="img_2" class="img-fluid" />

                                </div>
                            </div>

                            <input type="file" class="form-control file-fotografia2" />
                            <div class="help-block with-errors"></div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <label>
                                Fotografía ticket combustible
                            </label>

                            <div class="card bg-light" style="width: 18rem;">
                                <div class="card-body text-center">
                                    <img src="../img/logo_small.jpg" id="img_3" class="img-fluid" />

                                </div>
                            </div>

                            <input type="file" class="form-control file-fotografia3" />
                            <div class="help-block with-errors"></div>
    ...
    <div id="panelFinalizarIndividual" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p id="msgFinalizarIndividual">
                    </p>
                </div>
                <div class="modal-footer">
                    <button id="btnFinalizarIndividualAceptar" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancelar</button>
                </div>
            </div>
        </div>
    ...
    <div id="panelCancelar" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p id="msgCancelarSolicitud">
                    </p>
                </div>
                <div class="modal-footer">
                    <button id="btnCancelarAceptar" class="btn btn-danger" data-dismiss="modal">Aceptar</button>
                    <button id="btnCancelarCancelar" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../js/cp/combustibles/combustibles_aprobacion.min.js"></script>
    <script src="../js/cp/combustibles/combustibles_imagenes.min.js"></script>
