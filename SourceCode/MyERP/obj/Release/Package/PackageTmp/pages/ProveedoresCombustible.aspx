<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProveedoresCombustible.aspx.cs" Inherits="Plataforma.pages.ProveedoresCombustible" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Proveedores de combustibles</h1>
                    ...
                    <div class="table-responsive">
                        <table style="width: 100%!important;" class="table table-striped table-bordered table-hover " id="table">
                            ...
                            <thead>
                                ...
                                <th style="width:200px; ">Nombre contacto</th>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtNombreContacto" placeholder="Nombre del contacto"
                                        required data-required-error='Requerido' />
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="txtDomicilio" placeholder="Domicilio" class="form-control" type="text"
                                        required data-required-error='Requerido' />
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Correo</label>
                                    <input id="txtCorreo" placeholder="Correo" class="form-control" type="text"
                                        required data-required-error='Requerido' />
                                    <div class="help-block with-errors"></div>
                                </div>
    ...
    <script src="../js/cp/combustibles/proveedores_combustible.js"></script>
