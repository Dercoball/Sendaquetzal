<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Refacciones.aspx.cs" Inherits="Plataforma.pages.Refacciones" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Refacciones</h1>
                            ...
                            <div class="form-body">
                                <h3 class="text-center">
                                 ...
                                 <div class="row">
                                    ...
                                    <label for="txtNumeroParte">Número de parte</label>
                                    <input type="text" class="form-control" id="txtNumeroParte" placeholder="Número de parte"
                                    ...
                                    <input style="text-transform:uppercase" type="text" class="form-control" id="txtDescripcion" placeholder="Descripcion"
                                        required data-required-error='Requerido' />
                                    <div class="help-block with-errors"></div>
                                    </div>
    ...
    <script src="../js/cp/catalogos/refacciones.js"></script>
