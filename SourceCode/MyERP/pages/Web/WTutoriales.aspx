<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WTutoriales.aspx.cs" Inherits="Plataforma.pages.WTutoriales" %>
...
<body>
       ...
       <header class="header">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Configuración de tutoriales</h1>
                </header>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="txtTitulo" required="required" data-required-error='Requerido'/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="txtUrlVideo">
                                            Video
                                        </label>
                                        <textarea class="form-control alto-textarea" id="txtUrlVideo" required="required" data-required-error='Requerido'></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
    ...
    <script src="../../js/app/web/wtutorial.js"></script>
