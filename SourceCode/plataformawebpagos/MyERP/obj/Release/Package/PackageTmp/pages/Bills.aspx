<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bills.aspx.cs" Inherits="Plataforma.pages.Bills" %>
...
<body>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="txtConcepto">
                                            Concepto
                                        </label>
                                        <input type="text" class="form-control" id="txtConcepto" required="required" data-required-error='Requerido' />
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="txtMonto" required="required" data-required-error='Requerido' />
                                        <div class="help-block with-errors"></div>
                                    </div>
    ...
    <script src="../../js/app/bills.js"></script>
