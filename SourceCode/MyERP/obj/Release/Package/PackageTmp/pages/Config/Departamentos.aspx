<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departamentos.aspx.cs" Inherits="Plataforma.pages.Departamentos" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Obras/Departamentos</h1>
    ...
    <div id="panelSeleccionarResidente" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Selección de residente</h4>
                ...
                <div class="modal-body">
                    <div class="modal-body form">
                        <form role="form" id="frmResidente" name="frmResidente">

                            <div class="row">

                                <div class="form-group">
                                    <label for="comboResidente">
                                        Residente/Empleado
                                    </label>
                                    <div id="comboResidente" class="form-control">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="btnAceptarSeleccionResidente" data-dismiss="modal">Aceptar</button>
            </div>
        </div>
    </div>
    </div>
    ...
    <script src="../js/cp/catalogos/departamentos.js"></script>
