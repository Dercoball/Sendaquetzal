...
{
    public partial class CategoriesMaterials : System.Web.UI.Page
    {
        const string pagina = "200";
        ...
        [WebMethod]
        public static CategoriaMateriales GetItem(string path, string id)
        {

            string strConexion = System.Configuration.ConfigurationManager.ConnectionStrings[path].ConnectionString;
            CategoriaMateriales item = new CategoriaMateriales();
            ...
            try
            {
                ...
                string query = @" SSELECT id, nombre, IsNull(es_material_entrega, 0) es_material_entrega
                     FROM categoria
                     WHERE  id =  @id ";
        ...
        [WebMethod]
        public static object Save(string path, CategoriaMateriales item, string accion, string idUsuario)
        {
            ...
            try
            {
                ...
                if (accion == "nuevo")
                {
                    sql = @" INSERT INTO categoria(nombre, eliminado, es_material_entrega) 
                    VALUES (@nombre, 0, @es_material_entrega)  ";
                }
                else
                {
        ...
        [WebMethod]
        public static List<CategoriaMateriales> GetListaItems(string path, string idUsuario)
        {

            string strConexion = System.Configuration.ConfigurationManager.ConnectionStrings[path].ConnectionString;

            SqlConnection conn = new SqlConnection(strConexion);
            List<CategoriaMateriales> items = new List<CategoriaMateriales>();
            ...
            try
            {
                conn.Open();
                DataSet ds = new DataSet();
                string query = @" SELECT id, nombre, IsNull(es_material_entrega, 0) es_material_entrega
                     FROM categoria
                     WHERE 
