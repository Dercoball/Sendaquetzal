<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calendar.aspx.cs" Inherits="Plataforma.pages.Calendar" %>
            ...
            <div class="container-fluid">
                ...
                <div id="panelPrincipal">
                    ...
                    <div class="row">
                       ...
                       <%-- SECCION DEL CALENDARIO--%>
                        <div id="calendario"  class="form-group col-md-6">

                            <img src="../../img/sq.jpg" class="img-responsive" />
                        
                        </div>

                        <%--SECCION LISTADO DE FECHAS--%>
                        <div id="fechas" class="form-group col-md-6">

                            <ul id="listaFechas" class="border" style="list-style-type: none;"></ul>
                ...
                <div id="indiceDias">
                    ...
                    <div class=" col-md-6 text-left">
                        <h2 class="h3 display"><i class="fa fa-th-list"></i> Dias de paro</h2>
                    </div>

                    <div class=" col-md-6 text-left">
                        <h2 class="h3 display"><i class="fa fa-th-list"></i> Cumpleaños</h2>
                    </div>

                    <div class=" col-md-6 text-left">
                        <h2 class="h3 display"><i class="fa fa-th-list"></i> Dias no laborales</h2>
                    </div>
