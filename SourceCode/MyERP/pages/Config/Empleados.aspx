<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Empleados.aspx.cs" Inherits="Plataforma.pages.Empleados" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Empleados</h1>
                        ...
                        <form role="form" id="frm" name="frm">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <label for="comboPuesto">
                                            Puesto
                                        </label>
                                        <select class="form-control" id="comboPuesto"
                                            required data-required-error='Requerido'>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
    ...
    <script src="../js/cp/catalogos/empleados.js"></script>
