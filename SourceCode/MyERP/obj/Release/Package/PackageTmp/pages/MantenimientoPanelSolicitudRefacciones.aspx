<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoPanelSolicitudRefacciones.aspx.cs" Inherits="Plataforma.pages.MantenimientoPanelSolicitudRefacciones" %>
...
<body>
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    ...
                    <h1 class="h3 display">Solicitud de refacciones</h1>
                ...
                <div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <button id="btnAbrirSeleccionarRequisicion" class="btn btn-outline btn-primary form-control deshabilitable">Seleccione requisición...</button>
                                    </div>


                                    <div class="form-group col-md-8">
                                        <label for="txtRequisicion">
                                            No. de requisición
                                        </label>
                                        <input type="text" class="form-control" id="txtRequisicion" disabled />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="txtDiagnostico" disabled
                                            required data-required-error='Requerido' rows="4">
                    ...
                    <div class="mt-2">
                        <h4 class="text-center ">Solicitud de refacciones
                        </h4>
                    </div>
                                ...
                                <%--<form role="form" id="frmRefaccion" name="frmRefaccion">--%>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="radio" id="radioUrgente" value="urgente" name="urgenteono" />
                                                <label for="radioUrgente">
                                                    Urgente
                                                </label>
                                                <div class="help-block with-errors"></div>

                                                <input type="radio" id="radioNormal" value="normal" name="urgenteono" checked="checked" />
                                                <label for="radioNormal">
                                                    Normal
                                                </label>
                                                <div class="help-block with-errors"></div>
                                            </div>
    ...
    <div id="panelImagen" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span id="spanImagen"><img id="imgDoc" class="img-fluid" /></span>
                </div>
                <div class="modal-footer">
    ...
    <script src="../js/cp/manteminimiento/panel_refacciones.js"></script>
    <script src="../js/cp/manteminimiento/datos_equipo.js"></script>
