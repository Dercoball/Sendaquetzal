...
var table;
var date = new Date();
var descargas = "Marcas_" + date.getFullYear() + "_" + date.getMonth() + "_" + date.getUTCDay() + "_" + date.getMilliseconds();
var pagina = '11';
...
$(document).ready(function () {
    ...
    $('#btnGuardar').click(function (e) {
        ...
        if (!hasErrors) {
            ...
            marca.Id_Marca = idSeleccionado;
            marca.Nombre = $('#txtNombre').val();
    ...
    $('#btnEliminarAceptar').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../pages/Marcas.aspx/EliminarMarca",
            data: parametros,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
...
function editar(id) {
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            var datosMarca = msg.d;
            $('#txtNombre').val(datosMarca.Nombre);
          


            idSeleccionado = datosMarca.Id_Marca;
            accion = "editar";
