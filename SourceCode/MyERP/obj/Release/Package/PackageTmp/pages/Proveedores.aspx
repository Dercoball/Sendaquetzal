<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="Plataforma.pages.Proveedores" %>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Proveedores</h1>
...
<%--                                <th>Correo</th>--%>
                    ...
                    <div class="modal-body form">
                        <form role="form" id="frm" name="frm" data-toggle="validator">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label>Celular</label>
                                    <input id="txtCelular" placeholder="Celular" class="form-control" type="text"
                                        required data-required-error='Requerido' />
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
    ...
    <script src="../js/cp/catalogos/proveedores.js"></script>
