<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoConsultaEquipos.aspx.cs" Inherits="Plataforma.pages.MantenimientoConsultaEquipos" %>
...
<body>
                            ...
                            <form role="form" id="frm" name="frm">
                                ...
                                <div class="form-body">
                                    ...
                                    <%--    <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtDescripcion" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>--%>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtNumeroSerie" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="checkbox" id="chkOperativo" disabled />
    ...
    <script src="../js/cp/mantenimiento/consulta_equipos.js"></script>
