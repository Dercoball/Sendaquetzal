<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvestmentsDashboard.aspx.cs" Inherits="Plataforma.pages.InvestmentsDashboard" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Inversión</h1>
                </header>

                <div id="panelInversiones">

                     <div id="container_grafica_InversionDisponible">
                                </div>
    ...
    <script src="../../js/app/investors/dashboard.js"></script>
