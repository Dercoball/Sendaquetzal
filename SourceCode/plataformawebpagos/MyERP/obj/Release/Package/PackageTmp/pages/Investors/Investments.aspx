                        ...
                        <form role="form" id="frm" name="frm">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="txtMontoAInvertir">
                                            Monto a invertir  
                                        </label>
                                        <input type="number" step="any" class="form-control" id="txtMontoAInvertir" required="required" data-required-error='Requerido' />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-check ml-2">
                                            <input id="chkUtilidades" class="form-check-input" type="checkbox" />
                                            <label for="chkUtilidades" class="form-check-label">Retirar utilidades</label>
                                        </div>
                                    </div>

                                    
                                    <div class="form-group col-md-6">
                                        <label for="comboPeriodos">
                                            Periodos de corte
                                        </label>
                                        <select class="form-control campo-combo" id="comboPeriodos" required="required" data-required-error='Requerido'>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="file" class="form-control file-comprobante" data-tipo="1"
