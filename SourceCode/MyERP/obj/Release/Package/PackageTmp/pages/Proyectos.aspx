<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proyectos.aspx.cs" Inherits="Plataforma.pages.Proyectos" %>
...
<body>
                    ...
                    <div id="panelForm">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtFechaCreacion" placeholder="" disabled
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtNumeroRequisicion" placeholder="" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" id="txtFecha" placeholder="" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control" id="txtNombreEquipo" placeholder="" disabled />
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtNumeroEconomico" placeholder="" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtNumeroSerie" placeholder="" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="txtAnio" placeholder="" disabled
                                                required data-required-error='Requerido' />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="txtCoordenadas" disabled />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4" id="divDocumentos">
                                        </div>
                                    ...
                                    <hr />
                                    <div class="mt-5">
                                        <h4 class="text-center ">Diagnóstico  / Servicio
                                        </h4>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control deshabilitable" id="txtDiagnostico"    
                                                required data-required-error='Requerido' rows="4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="txtDescripcionServicio1">
                                                Descripcion de Servicio 
                                            </label>
                                            <textarea class="form-control deshabilitable" id="txtDescripcionServicio1" rows="4"></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div>
                        ...
                        <div class="row mt-3 mb-3">
                            ...
                            <div class=" col-md-6 text-right">
                                <button id="btnGuardar" class="btn btn-primary deshabilitable"><i class="fa fa-check"></i>Aceptar requisición y generar orden de trabajo</button>
                            </div>
    ...
    <div class="modal fade" id="panelSeleccionarCita" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
    ...
    <script src="../js/cp/proyectos.js"></script>
