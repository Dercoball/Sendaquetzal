<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Utilities.aspx.cs" Inherits="Plataforma.pages.Utilities" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <div id="comboInversionistas">

                    <h3 class="text-left">Utilidades
                    </h3>
                ...
                <div id="panelUtilidades">

                    <div id="container_grafica_Utilidades">
                    </div>
                ...
                <div id="panelTabla">
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class=" col-md-6 text-left">
                            <button id="btnExportar" class="btn btn-primary deshabilitable"><i class="fa fa-save mr-1"></i>Exportar</button>
                        </div>
 ...
 <!-- JavaScript files-->
    ...
    <script src="../../js/app/investors/utilities.js"></script>
