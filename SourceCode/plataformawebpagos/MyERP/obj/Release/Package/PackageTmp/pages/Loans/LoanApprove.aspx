...
<head runat="server">
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="<%= ResolveUrl("~/vendor/bootstrap/css/bootstrap.min.css") %>" />
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<%= ResolveUrl("~/vendor/font-awesome/css/font-awesome.min.css") %>" />
    <!-- Fontastic -->
    <link rel="stylesheet" href="<%= ResolveUrl("~/css/fontastic.css") %>" />
    <!-- Google fonts - Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700" />
    <!-- jQuery Circle -->
    <link rel="stylesheet" href="<%= ResolveUrl("~/css/grasp_mobile_progress_circle-1.0.0.min.css") %>" />
    <!-- Custom Scrollbar -->
    <link rel="stylesheet" href="<%= ResolveUrl("~/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css") %>" />
    <!-- Theme -->
    <link rel="stylesheet" href="<%= ResolveUrl("~/css/style.sea.css") %>" />
    <!-- Custom -->
    <link rel="stylesheet" href="<%= ResolveUrl("~/css/custom.css") %>" />
    <!-- Favicon -->
    <link rel="shortcut icon" href="<%= ResolveUrl("~/img/sq.jpg") %>" />

    <!-- Raíz app para JS -->
    <script type="text/javascript">
        window.APP_ROOT = '<%= ResolveUrl("~/") %>'; // ej. "/"
    </script>
    ...
    <style>
        ...
        i.fa-camera, i.fa-folder { cursor: pointer; font-size: 25px; }
        i:hover { opacity: 0.6; }
        input[type=file] { display: none; }
        #flImagenGarantia { display: inline; }
    </style>
</head>
<body>
    <form class="form-signin" id="form1" runat="server">
        <!-- Hidden (pueden estar disabled si solo se muestra la vista) -->
        <asp:HiddenField ID="txtUsuario" runat="server" />
        <asp:HiddenField ID="txtIdTipoUsuario" runat="server" />
        <asp:HiddenField ID="txtIdUsuario" runat="server" />
        <asp:HiddenField ID="hfIdPrestamo" runat="server" />
            ...
            <div class="side-navbar-wrapper">
                <div class="sidenav-header d-flex align-items-center justify-content-center">
                    ...
                    <div class="sidenav-header-logo">
                        <a href="<%= ResolveUrl("~/pages/Index.aspx") %>" class="brand-small text-center">
                            <strong>S</strong><strong class="text-primary">Q</strong>
                        </a>
                    </div>
                </div>
                ...
                <nav class="navbar">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a href="<%= ResolveUrl("~/pages/Index.aspx") %>" class="navbar-brand">
                                <div class="brand-text d-none d-md-inline-block">
                                    <span></span><strong class="text-primary"><span id="systemName"></span></strong>
                                </div>
                            </a>
                        </div>
                        <ul class="nav-menu list-unstyled d-flex flex-md-row">
                            <li class="nav-item">
                                <a href="#" class="nav-link logout" onclick="window.top.location.href = '<%= ResolveUrl("~/pages/Logout.aspx") %>'">
                    ...
                    <div class="card rounded">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select class="form-control campo-combo" id="cboTipoCliente"
                                            required="required" data-required-error="Requerido"></select>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-label">Cantidad de préstamo</label>
                                    <input type="number" class="form-control campo-input" id="txtCantidadPrestamo"
                                           required="required" data-required-error="Requerido" />
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-label">Máximo por renovación</label>
                                    <input type="number" class="form-control campo-input" id="txMaximoPorRenovacion"
                                           required="required" data-required-error="Requerido" />
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-3">
                                    <label class="form-label">Préstamos completados</label>
                                    <input class="form-control campo-input" id="txtPrestamosCompletados" readonly="true" />
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-label">Préstamos rechazados</label>
                                    <input class="form-control campo-input" id="txtPrestamosRechazados" readonly="true" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="panelForm" class="mt-4">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <form role="form" id="frmAprobacion" name="frmAprobacion" data-toggle="validator">
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control campo-textarea" id="txtNotaAprobacion" rows="4"
                                                              required="required" data-required-error="Requerido"></textarea>
                                                </div>
                                            </div>

                                            <div class="row mb-3 col-12" id="dvBotonAgregarGarantia">
                                                <a class="btn btn-primary text-white rounded" data-toggle="modal" data-target="#mdlGarantia">
                                                    AGREGAR GARANTÍA <i class="fa fa-plus-circle"></i>
                                                </a>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="nav-aprobacion-ejecutivo" role="tabpanel" aria-labelledby="nav-aprobacion-ejecutivo-tab">
                                <div class="card">
                                    <div class="card-body">
                                        <form role="form" id="frmAprobacionEjecutivo" name="frmAprobacionEjecutivo" data-toggle="validator">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="form-label w-100">Notas</label>
                                                    <textarea class="form-control campo-textarea" id="txtNotaAprobacionEjecutivo" rows="4"
                                                              required="required" data-msg-required="Ingrese la nota de aprobación"></textarea>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="row mt-3 mb-3">
                            <div class="col-md-12 text-center">
                                <a class="btn btn-secondary rounded cancelar" href="<%= ResolveUrl("~/pages/Loans/LoanRequest.aspx") %>">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" id="txtNombreGarantia" required="required" data-msg-required="Ingrese nombre" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label>Número de serie</label>
                                        <input type="text" class="form-control" id="txtNumeroSerie" required="required" data-msg-required="Ingrese número de serie" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Costo</label>
                                        <input type="number" class="form-control" id="txtCosto" step="0.1" required="required" data-msg-required="Ingrese el costo" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12 text-center">
                                ...
                                <div class="row mt-3 mb-3">
                                    <div class="col-md-6 text-center">
                                        <button id="btnCancelarGarantíaCliente" data-dismiss="modal" class="btn btn-secondary">
                                            <i class="fa fa-arrow-circle-left"></i>&nbsp;CANCELAR
                                        </button>
                                        <a id="btnAgregarGarantia" class="btn btn-primary text-white">
        ...
        <!-- Paneles de mensajes (igual que tenías) -->
        <div id="panelMensajes" class="modal fade" role="dialog" data-backdrop="static" style="margin-top:200px;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"><h4 class="modal-title text-center">Información</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
        ...
        <div id="panelMensajeControlado" class="modal fade" role="dialog" data-backdrop="static" style="margin-top:200px;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"><h4 class="modal-title text-center">Información</h4></div>
                    <div class="modal-body"><p><span id="spnMensajeControlado"></span></p></div>
                    <div class="modal-footer"><button class="btn btn-primary" id="btnAceptarPanelMensajeControlado">Aceptar</button></div>
                </div>
            </div>
        </div>
        ...
        <div id="panelEliminar" class="modal fade" role="dialog" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"><h4 class="modal-title text-center">Confirmación</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body"><p>Se eliminará el registro seleccionado. ¿Desea continuar?</p></div>
        ...
        <!-- DataTables -->
        <script src="<%= ResolveUrl("~/vendor/datatables/js/jquery.dataTables.min.js") %>"></script>
        <script src="<%= ResolveUrl("~/vendor/datatables-plugins/dataTables.bootstrap.min.js") %>"></script>
        <script src="<%= ResolveUrl("~/vendor/datatables-responsive/dataTables.responsive.js") %>"></script>
        <script src="<%= ResolveUrl("~/vendor/datatables/js/dataTables.bootstrap4.js") %>"></script>

        <link href="<%= ResolveUrl("~/vendor/datatables-responsive/dataTables.responsive.css") %>" rel="stylesheet" />
        <link href="<%= ResolveUrl("~/vendor/datatables/css/jquery.dataTables.css") %>" rel="stylesheet" />
        <link href="<%= ResolveUrl("~/vendor/datatables/css/dataTables.bootstrap4.css") %>" rel="stylesheet" />
        <link href="<%= ResolveUrl("~/vendor/datatables-plugins/dataTables.bootstrap.css") %>" rel="stylesheet" />
        <script src="<%= ResolveUrl("~/vendor/datatables-plugins/Buttons-1.5.1/js/dataTables.buttons.min.js") %>"></script>
        <script src="<%= ResolveUrl("~/vendor/datatables-plugins/Buttons-1.5.1/js/buttons.html5.min.js") %>"></script>

        <script src="<%= ResolveUrl("~/js/validator.js") %>"></script>
        <script src="<%= ResolveUrl("~/js/app/loans/loans.js") %>?v=<%= DateTime.UtcNow.Ticks %>"></script>

        <script src="<%= ResolveUrl("~/js/app/general.js") %>"></script>

        <!-- Toastr -->
        <link href="<%= ResolveUrl("~/css/toastr.min.css") %>" rel="stylesheet" />
        <script src="<%= ResolveUrl("~/js/toastr.min.js") %>"></script>
