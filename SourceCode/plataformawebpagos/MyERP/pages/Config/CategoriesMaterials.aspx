<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoriesMaterials.aspx.cs" Inherits="Plataforma.pages.Categories" %>
    ...
    <div class="page">
        ...
        <!-- <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display">Categorías Activos y Materiales</h1>
                </header>
