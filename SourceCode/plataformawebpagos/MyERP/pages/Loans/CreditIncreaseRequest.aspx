<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditIncreaseRequest.aspx.cs" Inherits="Plataforma.pages.CreditIncreaseRequest" %>
...
<body>
    ...
    <div class="page">
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    <h1 class="h3 display" id="paginaName">Solicitudes de aumento de crédito</h1>
    ...
    <script src="../../js/app/loans/creditIncreaseRequest.js"></script>
