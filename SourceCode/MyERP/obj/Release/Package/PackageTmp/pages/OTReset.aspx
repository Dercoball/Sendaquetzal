<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OTReset.aspx.cs" Inherits="Plataforma.pages.OTReset" %>
...
<body>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer text-right">
                            ...
                            <button id="btnGenerarOts" class="btn btn-primary">
                                <img src="../img/loading4.gif" style="width: 2em; height: 2em; display: none;"
                                    id="imgLoading" />
                                Ejecutar proceso para generar OTs de mantenimiento
                            </button>

                            <button id="btnResetStatus" class="btn btn-outline-danger">
                                Resetear status de Ots en Atención a Por atender
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div id="panelGenerarOts" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="msgGenerarOts">
                    </div>
                </div>
                <div class="modal-footer">
                    <button id="btnGenerarOtsAceptar" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
    ...
    <script src="../js/cp/catalogos/otreset.js"></script>
