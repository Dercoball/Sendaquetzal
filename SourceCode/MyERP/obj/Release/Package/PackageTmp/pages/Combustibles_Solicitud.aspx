<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Combustibles_Solicitud.aspx.cs" Inherits="Plataforma.pages.Combustibles_Solicitud" %>
...
<body>
        ...
        <section class="forms">
            ...
            <div class="container-fluid">
                ...
                <header>
                    ...
                    <h1 class="h3 display">Solicitud de combustible</h1>
                        ...
                        <div id="panelForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <button id="btnGuardar" class="btn btn-primary"><i class="fa fa-save mr-1"></i>Guardar</button>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../js/cp/combustibles/combustibles_solicitud.js"></script>
