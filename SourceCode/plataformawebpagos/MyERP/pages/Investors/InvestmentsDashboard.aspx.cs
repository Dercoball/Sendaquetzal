...
{
    public partial class InvestmentsDashboard : System.Web.UI.Page
    {
        const string pagina = "55";
        ...
        public static List<Inversion> GetListaItems(string path, string idUsuario)
        {
            ...
            try
            {
                ...
                string query = @" SELECT i.id_inversion_total, i.id_inversionista, i.monto_total,                                          
                                         inv.nombre, inv.porcentaje_interes_anual
                         FROM inversion_total i  
